...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
	...
	export TARGET_DEVICE_ALT="x671,Infinix-X671,INFINIX-X671,x671b,INFINIX-X671B,Infinix-X671B" # I am not what are the over possible names.
	...
	export OF_FL_PATH1="/sys/devices/virtual/torch/torch/torch_level "2""
